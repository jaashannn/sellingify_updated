        ...
        <ul class="space-y-4">
          <li>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li>Your only cost: Global — no setup fee, 5 months free; India — one-time setup fee, then 5 months free. Then a small monthly subscription.</li>
          ...
          <li>
            ...
            <ul class="list-disc pl-5 space-y-2">
              <li>You pay: Global — no setup fee, 5 months FREE; India — one-time setup fee, then 5 months FREE. Then monthly subscription.</li>
